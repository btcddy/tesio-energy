...
export default function Team() {
  const members = [
    ...
    { img: '/Mechelle Pope.png', name: 'Mechelle Pope', role: 'Partner / Professional Engineer', bio: 'Mechelle is a seasoned professional with more than 15 years of experience spanning construction, project management, and risk consulting across property, casualty, and renewable energy sectors. She has led multidisciplinary teams and collaborated closely with stakeholders and contractors to assess technical risks and deliver engineering support on complex projects. Mechelle holds a Bachelor of Applied Science in Civil Engineering from the University of Waterloo, where she specialized in structural engineering and management sciences.' },
  ];
