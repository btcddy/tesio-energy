export const IconSolar = ({ stroke = '#2DB54E' }: { stroke?: string }) => (
...
export const IconRoof = ({ stroke = '#D4920F' }: { stroke?: string }) => (
...
export const IconTax = ({ stroke = '#1A9E8F' }: { stroke?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export const IconDoc = ({ stroke = '#2DB54E' }: { stroke?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export const IconBolt = ({ stroke = '#3D5A80' }: { stroke?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
  </svg>
);

export const IconPulse = ({ stroke = '#3DD962' }: { stroke?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
